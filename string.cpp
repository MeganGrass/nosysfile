...
// Boot
System_String::System_String(VOID) {
}
System_String::~System_String(VOID) {
}
// Create
...
ULONG System_String::GetArgCount(WCHAR * _Format, ...) {
...
WCHAR * System_String::GetArg(ULONG iArg, WCHAR * _Format, ...) {
...
VOID System_String::Message(WCHAR * _Format, ...) {
